...
SELECT * from student where point <> 6
SELECT * from student where point = 6 or point = 7
SELECT * from student where point = 7 and gender = 1
SELECT * from student where point = 7 and (class_id = 1 or class_id = 2)
SELECT * FROM student where point BETWEEN 1 and 6
